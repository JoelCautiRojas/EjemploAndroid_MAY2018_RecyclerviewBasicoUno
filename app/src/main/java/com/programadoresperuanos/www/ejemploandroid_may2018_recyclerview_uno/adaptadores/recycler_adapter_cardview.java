...
public class recycler_adapter_cardview extends RecyclerView.Adapter<recycler_adapter_cardview.ViewHolder>{

    private Context contexto;
    private LayoutInflater inflador;
    private List<recycler_model> datos;

    public recycler_adapter_cardview(Context contexto, List<recycler_model> datos) {
    ...
    @NonNull
    @Override
    public recycler_adapter_cardview.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = inflador.inflate(R.layout.item_recyclerview_cardview,parent,false);
        return new recycler_adapter_cardview.ViewHolder(v);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull recycler_adapter_cardview.ViewHolder holder, int position) {
